  ...
  return (
    <>
      ...
      <section className="site-section">
        ...
        <section className="mt-14 rounded-[28px] border border-green/20 bg-green/5 p-8 sm:px-10 sm:py-10">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {relatedPosts.map((relatedPost) => (
                <Link
                  ...
                  className="group site-card flex flex-col overflow-hidden transition-transform hover:-translate-y-1 hover:shadow-md"
                >
