...
import { payrollFAQs, services, getGoogleTestimonials } from '@/lib/site-data'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/services/payroll-hr-compliance`,
  },
}
...
export default async function PayrollHrCompliancePage() {
