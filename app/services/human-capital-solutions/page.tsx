...
import { humanCapitalFAQs, services, getGoogleTestimonials } from '@/lib/site-data'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${siteUrl}/services/human-capital-solutions`,
  },
}
...
export default async function HumanCapitalSolutionsPage() {
  ...
  return (
    <>
      ...
      <section className="site-section mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
