...
- Blog posts are managed in WordPress and loaded through the WordPress REST API. The existing `blog-posts.json` file is retained as a migration archive only.
